 ...
 *
 */
public class IsUnion implements TernaryOperator<Set,SetElement> {
	...
	public SetElement evaluate(Evaluable<Set> operandOne, Evaluable<Set> operandTwo, Evaluable<Set> operandThree) {
		return new BooleanElement( operandOne.evaluate().isUnionSet(operandTwo.evaluate(), operandThree.evaluate()) );
	}
